{
    ...
    "PlayerData":
	{
		...
		{
			"timeToStrafeJog": 0.1,
			"rotationSpeedJog": 0.1,
			"timeToSprint": 0.1,
			"timeToStrafeSprint": 0.1,
			"rotationSpeedSprint": 0.1,
	...
	{
		"lightingConfig": 0,
		"objectSpawnersArr": ["custom/CHERNO-AIR-DROP-NWAF-JJMODS.json","custom/CHERNO-AIR-DROP-BELOTA-JJMODS.json","custom/converted-NEWTRADER.json"],
